<template>
	<div class="density-root">
		...
		<small>Caution: This software is still under development and there is no easy export functionality, yet. If you need to export the data, hit the button and copy the text below into Excel.</small>
